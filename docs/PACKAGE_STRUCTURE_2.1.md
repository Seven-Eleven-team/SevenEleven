...
│   ├── 📄 TermsApiController.java                (회원가입 전 이용약관 목록 조회 API - DB TERMS 기준)
│   ├── 📄 AdminTermsApiController.java           (관리자 약관 조회 / 신규 버전 등록 API)
...
│   │   ├── 📄 SignupRequest.java                 (회원가입 입력값 + 약관 동의 TERM_ID 목록)
│   │   ├── 📄 FindPasswordRequest.java           (비밀번호 찾기 입력값)
│   │   └── 📄 ResetPasswordRequest.java          (비밀번호 재설정 입력값)
│   │
│   ├── 📂 terms
│   │   ├── 📄 TermsResponse.java                 (회원가입 약관 모달에 출력할 약관 응답값)
│   │   └── 📄 TermsSignupResponse.java           (회원가입 약관 목록 + 필수 약관 타입 응답값)
│   │
│   ├── 📂 user
...
│   │   ├── 📄 TermsRequest.java                  (약관 신규 버전 등록 / 수정 입력값)
...
│
├── 📂 service                                     (서비스)
│   ├── 📄 AuthService.java                       (로그인 / 회원가입 / 세션 처리, 회원가입 전 필수 약관 검증 호출)
│   ├── 📄 TermsService.java                      (DB TERMS 기준 최신 약관 조회 / 회원가입 약관 목록 제공)
│   ├── 📄 TermsAgreementService.java             (회원가입 요청의 필수 약관 동의 여부 검증)
...
│   ├── 📄 AdminTermsService.java                 (관리자 약관 조회 / 신규 버전 등록 / DB TERMS 관리)
...
│   ├── 📄 TermsRepository.java                   (TERMS 테이블 접근 / 최신 약관 조회)
...
│   ├── 📄 Report.java                            (신고 엔티티)
│   ├── 📄 Terms.java                             (TERMS 테이블 매핑 약관 엔티티)
│   ├── 📄 TermsType.java                         (약관 종류 제약 enum - SERVICE / PRIVACY / POLICY / MARKETING)
