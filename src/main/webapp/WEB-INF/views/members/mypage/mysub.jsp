        ...
        <div id="sub-active-content" class="tab-content active">
            <div class="manage-grid">
                ...
                <c:if test="${empty subscriptions}">
                    <p style="color:#888; font-size:16px; padding:40px 0;">
                        현재 구독 중인 서비스가 없습니다.
                    </p>
                </c:if>
                        ...
                        <section class="manage-right">
                            <div class="detail-card">
                                ...
                                <table class="detail-info-table">
                                    <tr>
                                        <td style="color: #ff4d4d; font-weight: bold; width: 110px; text-align: left;">
                                            공유 계정 ID
                                        </td>
                                ...
                                <div class="history-info">
                                    <strong>
                                        ...
                                        <c:if test="${sub.status eq 'CANCELLED'}">
                                            <c:if test="${empty sub.startDate or sub.startDate ge today}">
                                                <span style="color: #ff4d4d; font-size: 14px; margin-left: 6px; font-weight: bold;">
                                                    (취소됨)
                                                </span>
                                            </c:if>

                                            <c:if test="${not empty sub.startDate and sub.startDate lt today}">
                                                <span style="color: #ff4d4d; font-size: 14px; margin-left: 6px; font-weight: bold;">
                                                    (해지됨)
                                                </span>
                                            </c:if>
...
<div id="termsModal" class="terms-modal-overlay">
    <div class="terms-modal-content">
        ...
        <div class="terms-text">
            ...
            <p>
                "지출메이트 플랫폼은 회원 간의 구독 쉐어 매칭 지원할 뿐, 실제 분할 결제 이행 여부 및 사기 등 회원 간의 사적 거래에서 발생하는 금전적 피해에 대해서는 회사가 일체 법적 책임을 지지 않는다"는 방어 조항(면책 조항) 명시
            </p>
        </div>
